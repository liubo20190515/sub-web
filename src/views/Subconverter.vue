...
export default {
    ...
    var data = {
      ...
      options: {
        ...
        customBackend: {
          ...
          "subconverter-psi.vercel.app(自动编译最新版本后端-测试）": "https://subconverter-psi.vercel.app/sub?",
        ...
        backendOptions: [
          ...
          { value: "https://subconverter-psi.vercel.app/sub?" },
  ...
  mounted() {
    ...
    this.form.customBackend = "https://subconverter-psi.vercel.app/sub?";
