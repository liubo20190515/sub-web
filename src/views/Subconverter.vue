...
export default {
    ...
    var data = {
      ...
      options: {
        ...
        customBackend: {
          ...
          "subconverter-phi.vercel.app(自动编译最新版本后端-测试）": "https://subconverter-phi.vercel.app/sub?",
        ...
        backendOptions: [
          ...
          { value: "https://subconverter-phi.vercel.app/sub?" },
  ...
  mounted() {
    ...
    this.form.customBackend = "https://subconverter-phi.vercel.app/sub?";
